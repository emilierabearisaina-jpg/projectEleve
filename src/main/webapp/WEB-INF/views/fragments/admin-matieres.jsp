        ...
        <form action="/admin/matieres/save" method="post">
            ...
            <div class="form-actions">
                ...
                <c:if test="${not empty param.editId}">
                    <a href="?tab=matieres" class="btn-cancel" style="text-align: center; text-decoration: none;">Annuler</a>
                </c:if>
            </div>
        </form>
    </div>
            ...
            <tbody>
                <c:forEach var="item" items="${matieres}">
                    <tr>
                        ...
                        <td>${item.nom}</td>
                        <td class="actions">
                            <a href="?tab=matieres&editId=${item.id}&editVal1=${item.nom}" class="btn-icon edit" style="text-decoration:none;">✏️</a>
                            <a href="/admin/matieres/delete/${item.id}" class="btn-icon delete" style="text-decoration:none;">🗑️</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
